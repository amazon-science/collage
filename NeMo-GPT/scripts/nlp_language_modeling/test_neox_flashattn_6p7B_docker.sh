...
EXP_PATH=$SCRIPT_PATH/log_gpt_6p7B/mix_bf16_$(date "+%y-%m-%d-%H-%M")-gpt-neox-6p7B-nemo
...
AL=1
precision='bf16'
optim_name='adamw_monitor'
optim_name='adamw_base'

TRAIN_ITERS=20000

EXP_NAME=test_gpt_6p7B
