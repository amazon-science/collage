...
#     -e PYTHONPATH=/workspace/gpt-neox \
...
# docker exec $DOCKER_NAME pip install -r /workspace/gpt-neox/requirements/requirements_lightning.txt
# echo ">>> Installing common packages ..."
# docker exec $DOCKER_NAME pip install -r /workspace/gpt-neox/requirements/requirements_common.txt
# echo ">>> Installing nlp packages ..."
# docker exec $DOCKER_NAME pip install -r /workspace/gpt-neox/requirements/requirements_nlp.txt
# docker exec $DOCKER_NAME pip install -r /workspace/gpt-neox/requirements/requirements.txt
