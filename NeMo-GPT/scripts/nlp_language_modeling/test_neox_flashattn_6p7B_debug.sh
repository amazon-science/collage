...
TAG=nemo-23.06-efa
REGION=us-west-2
# aws configure set aws_access_key_id ASIARAVBMGBNKL4CMBHP
# aws configure set aws_secret_access_key w4phMYc/5yqTk3Q4k0jcYdEwGRNvelqTVP/LIyRa
# aws configure set aws_session_token 
...
SEQ_PARALLEL=False
Kahan='none' # 'kahan', 'mckahan', 'none'
ACT_CHK=null
AMP_O2=Tr
GRAD_DIV_FUSION=False # default =True when AMP-O2 and PP=1
FULL_BF16=False
...
GPT_ARGS="
    ...
    model.grad_div_ar_fusion=$GRAD_DIV_FUSION \
...
if [ $NODEID -eq 0 ]
then
	torchrun $DISTRIBUTED_ARGS $SCRIPT_PATH/examples/nlp/language_modeling/megatron_gpt_pretraining.py \
        $GPT_ARGS \
