...
class MegatronBaseModel(NLPModel):
    ...
    def configure_gradient_clipping(self, *args, **kwargs):
        ...
        if self.with_distributed_adam:
            ...
            skip_float32_check = True if self.full_bf16 else False
            grad_norm = clip_grad_norm_fp32(parameters=parameters, max_norm=clip_val, skip_float32_check=skip_float32_check)
